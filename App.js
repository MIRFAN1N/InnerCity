...
import {IntroScreen, HomeScreen, WelcomeScreen, RegisterScreen, LoginScreen, ProfileScreen, GamesScreen} from './lib/screens/Test/Main'
    ...
    return(
      <NavigationContainer>
        <Tabs.Navigator  screenOptions={MainNavigatorOpt}>
          <Tabs.Screen name='Intro' component={AppIntro} options={{tabBarVisible: false,tabBarButton: (props) => null,}}/>
          <Tabs.Screen name='Main' component={MainStackScreen} options={{tabBarVisible: false,tabBarButton: (props) => null,}}/>
        </Tabs.Navigator>
      </NavigationContainer>
    );
}
