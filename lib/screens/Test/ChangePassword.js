...
export const ChangePasswordScreen = () => {
  ...
  if (showCurrPass) {
    CurrPassIcon = require('../../assets/images/icons/eyeball-icon.png');
  } else {
    CurrPassIcon = require('../../assets/images/icons/eye-closed.png');
  }

  if (showNewPass) {
    NewPassIcon = require('../../assets/images/icons/eyeball-icon.png');
  } else {
    NewPassIcon = require('../../assets/images/icons/eye-closed.png');
  }
