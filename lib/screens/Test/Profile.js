...
const UserInfo = props => {
  ...
  const LogoutUser = () => {
    axios.get(Constant.LIVE_API_URL + 'user/logout', {
        headers: {
  ...
  const DeleteUser = async () =>{
    await axios.delete(Constant.LIVE_API_URL + 'user/delete/' + id, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    }).then((res)=>{
      ...
      Dialog.show({
        ...
        title: 'Success',
        textBody: 'Your profile has been disabled!',
        button: 'OK!',
        onPressButton: () => {
          navigation.navigate('Intro', {
            login: 0,
  ...
  return (
    <View style={ProfileStyles.TextGridOuter}>
      ...
      <View style={ProfileStyles.TextGrid}>
        ...
        <View>
          <Text style={ProfileStyles.TextColorWhiteBold}>Coming Soon</Text>
        </View>
        <View>
      ...
      <View style={ProfileStyles.LogoutOuter}>
          <TouchableOpacity onPress={DeleteUser}>
            <Text
              style={[ProfileStyles.TextColorRed, ProfileStyles.LogoutText]}>
              Disable Account
            </Text>
          </TouchableOpacity>
      </View>
