    ...
    <Tab.Navigator screenOptions={MainNavigatorOpt}>
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({color, size}) => (
            <Image
              source={require('../../assets/images/icons/profile-nav.png')}
              style={AllStyles.TabIcons}
            />
          ),
        }}
      />
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({color, size}) => (
            <Image
              source={require('../../assets/images/icons/home-nav.png')}
              style={[AllStyles.TabIcons, AllStyles.ActiveTabIcon]}
            />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({color, size}) => (
            <Image
              source={require('../../assets/images/icons/game-nav.png')}
              style={AllStyles.TabIcons}
            />
          ),
        }}
