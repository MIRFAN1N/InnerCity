...
import {AllStyles, GamesStyle, IntroStyle, Customized} from '../../util/styles/Theme';
// Vars
            ...
            <View style={Customized.BottomNavGrid}>
                <View style={Customized.BottomNavCol}>
                    <View style={Customized.BottomNavColInner}>
                        <TouchableOpacity style={Customized.BottomNavColLink} onPress={()=>{navigation.navigate('Profile')}}>
                            <Image source={ProfileNav} style={[Customized.BottomNavIcon,Customized.PaddingLeft]}/>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={Customized.BottomNavCol}>
                    <View style={Customized.BottomNavColInner}>
                        <TouchableOpacity style={Customized.BottomNavColLink} onPress={()=>{navigation.navigate('Home')}}>
                            <Image source={HomeNav} style={Customized.BottomNavIconCenter}/>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={Customized.BottomNavCol}>
                    <View style={Customized.BottomNavColInner}>
                        <TouchableOpacity style={Customized.BottomNavColLink} onPress={()=>{navigation.navigate('Games')}}>
